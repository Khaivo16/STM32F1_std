...
//  GPIO_Init(GPIOB, &GPIO_InitStructure);			     //GPIOB.5		
	//PIN_Init(GPIOC,GPIO_Pin_13,GPIO_Mode_Out_PP,GPIO_Speed_50MHz);
	GPIO_SETUP(GPIOC,GPIO_Pin_13,GPIO_Mode_Out_PP,GPIO_Speed_50MHz);
  LED0=1;//GPIO_SetBits(GPIOC,GPIO_Pin_13);					//PB.5 =0
